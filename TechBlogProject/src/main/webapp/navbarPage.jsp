 <nav class="navbar navbar-expand-lg navbar-light primary-back ">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item">
        <a class="nav-link text-white" href="login.jsp"><span class="fa fa-user-circle"></span>Login</a>
      </li>
      
      <li class="nav-item">
        <a class="nav-link text-white" href="register.jsp"><span class="	fa fa-user-plus"></span>Sign up</a>
      </li>
    </ul>
